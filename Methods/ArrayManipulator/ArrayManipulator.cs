...

{
    internal class ArrayManipulator
    {
        static void Main(string[] args)
        {
            ...
            while ((cmd = Console.ReadLine()) != "end")
            {
                ...
                else if (cmdType == "max" || cmdType == "min")
                {
                    ...
                    if (cmdType == "max")
                    {
                        indexOfMaxEl = IndexOfMaxEvenOrOddEl(arr, evenOrOddArg);
                    }
                    else
                    {
                        indexOfMaxEl = IndexOfMinEvenOrOddElement(arr, evenOrOddArg);
                    }
        ...
        static int IndexOfMaxEvenOrOddEl(int[] arr, string evenOrOddArg)
        {
